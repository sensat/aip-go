...
const file_einride_example_freight_v1_freight_service_proto_rawDesc = "" +
	...
	"\x0eDeleteShipment\x121.einride.example.freight.v1.DeleteShipmentRequest\x1a$.einride.example.freight.v1.Shipment\"0\xdaA\x04name\x82\xd3\xe4\x93\x02#*!/v1/{name=shippers/*/shipments/*}\x1a\x1f\xcaA\x1cfreight-example.einride.techB\x89\x02\n" +
